...
public class EADIMPSchemaPlugin
    ...
    public EADIMPSchemaPlugin() {
        super(IDENTIFIER, allNamespaces);
    }


    /**
     * Always return null. Not implemented for EADIMP records.
     *
     * @param metadata
     * @return
     */
